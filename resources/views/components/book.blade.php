<div class="w-1/4 p-4">
    <div class="rounded overflow-hidden border">
        <img class="w-full h-64 object-contain" src={{ $img }} alt="Sunset in the mountains">
        <div class="px-4 py-2 border-t">
            <div class="font-bold text-xl mb-2">The Book</div>
            <div class="flex">
                ...
                <div class="ml-2 flex flex-col">
                    <a class="hover:underline" href="#">Username</a>
                    <small>Rs. 400</small>
                </div>
            </div>
        </div>
